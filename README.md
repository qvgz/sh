...
| 文件名 | 介绍 |
| :- | :- |
| [centos-7-kernel-lts.sh](https://github.com/qvgz/sh/blob/master/install/centos-7-kernel-lts.sh) | [安装 CentOS 7 ELRepo LTS 内核（kernel-lt）](https://qvgz.org/sh/install/centos-7-kernel-lts.sh) |
...
| 文件名 | 介绍 |
| :- | :- |
| [check-ip.sh](https://github.com/qvgz/sh/blob/master/func/check-ip.sh) | [检查 IP 格式 (IPv4)](https://qvgz.org/sh/func/check-ip.sh) |
...
| [create-name.sh](https://github.com/qvgz/sh/blob/master/func/create-name.sh) | [生成随机用户名](https://qvgz.org/sh/func/create-name.sh) |
